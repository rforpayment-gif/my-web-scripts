//Saving data to database (Form submit)
        ...
        if (count > headlen) {
            ...
            var results = $('input[name="counter[]"]').map(function() {
                if ($(this).val() === 'visible') {
                    ...
                    var capex = container.find('input[name="capex[]"]').val();
                    var costcenter = container.find('input[name="costcenter[]"]').val();
                ...
                if (k == apprvlen) {
                    ...
                    $("select[name='proj[]']").each(function() {
                        ...
                        if(isWordIncluded==false){
                            ...
                            if(tempProj !== null){
                                var tempCapex = $("input[name='capex[]']").eq(x).val();
                                var tempCostcenter = $("input[name='costcenter[]']").eq(x).val();
